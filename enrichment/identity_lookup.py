...
Usage:
    ...
    #     "mfa_enabled": False,
    #     "risk_level": "high",
    #     "groups": ["Finance-Users", "ERP-Users"],
    #     "criticality": "HIGH",
...
_MOCK_BY_IP = {
    ...
    "10.0.0.20": {
        ...
        "mfa_enabled":    True,
        "risk_level":     "none",
        "groups":         ["Platform-Admins", "Directory-Admins"],
    ...
    "10.0.0.12": {
        ...
        "mfa_enabled":    False,
        "risk_level":     "none",
        "groups":         ["Directory-Controllers", "Platform-Admins"],
        "criticality":    "CRITICAL",
        "email":          None,
    },
    "10.0.0.10": {
    ...
    # Documentation IPs (RFC 5737) — same identities, for sample emails
    "192.0.2.15": {
        "display_name":   "Jordan Blake",
        "department":     "Finance",
        ...
        "groups":         ["Finance-Users", "ERP-Users"],
        "criticality":    "HIGH",
        "email":          "jordan.blake@northstar-example.test",
    },
    "192.0.2.20": {
        "display_name":   "Riley Quinn",
        "department":     "IT",
        ...
        "groups":         ["Platform-Admins", "Directory-Admins"],
        "criticality":    "CRITICAL",
        "email":          "riley.quinn@northstar-example.test",
    },
    "192.0.2.30": {
        ...
        "criticality":    "MEDIUM",
        "email":          "casey.morgan@northstar-example.test",
    },
}
...
_MOCK_BY_EMAIL = {
    ...
    # Northstar example domain — for sample emails (fictional)
    "jordan.blake@northstar-example.test": {
        "display_name":   "Jordan Blake",
        "department":     "Finance",
        "job_title":      "Financial Analyst",
        "manager":        "Riley Quinn",
    ...
    "casey.morgan@northstar-example.test": {
        "display_name":   "Casey Morgan",
        "department":     "Finance",
        "job_title":      "Compliance Officer",
        "manager":        "Riley Quinn",
    ...
    "riley.quinn@northstar-example.test": {
        "display_name":   "Riley Quinn",
        "department":     "IT",
        "job_title":      "IT Manager",
        "manager":        "Morgan Reed",
    ...
    "avery.smith@northstar-example.test": {
        "display_name":   "Avery Smith",
        "department":     "Marketing",
        "job_title":      "Marketing Director",
        "manager":        "Morgan Reed",
        ...
        "groups":         ["Marketing-Team", "Directors"],
        "criticality":    "MEDIUM",
        "email":          "avery.smith@northstar-example.test",
    },
}
...
_GROUP_CRITICALITY = {
    "Directory-Controllers": "CRITICAL",
    "Directory-Admins":      "CRITICAL",
    "Platform-Admins":          "CRITICAL",
